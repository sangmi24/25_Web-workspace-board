...
<div class="outer">
    ...
    <table align="center">
       ...
       <div id="file-area">
           ...
           <!--대표이미지(썸네일)은 필수-->
           <!--onchange : input 태그의 내용물이 변경될때 발생하는 이벤트  -->
       ...
       <script>
          $(function(){
           ...
           function loadImg(inputFile, num) {
               ...
               // files속성은 업로드된 파일의 정보들을 배열 형식으로 여러개 묶어서 반환
               // length 는 배열 크기
               ...
               if(inputFile.files.length == 1) {
                   ...
                   // FileReader 객체에서 제공하는 readAsDetaURL(파일정보)
                   // => 파일을 읽어들여서
                   //    해당 그 파일의 고유한 url 이 부여됨
                   ...
                   reader.onload = function(e) {
                	...
                	// e.target == reader
                    // e.target.result 에 각 파일의 url 값을 뽑아낼 것
                    // 각 영역에 맞춰서 이미지 미리보기
                    switch(num){
