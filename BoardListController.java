...
public class BoardListController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 ...
		 * 
		 * - 공식 구하기
		 * 단, boardLimit 가 10이라는 가정 하에 규칙을 구해보자
		 * 
		 ...
		 * 
		 * - 공식 구하기
		 * 단, pageLimit가 10이라는 가정 하에 규칙을 구해보자
		 * 
		 * 만약 pageLimit 가 10일 경우
		 ...
		 * ...
		 * 
		 * => currentPage / pageLimit => 1~9까지는 몫이 0, 10이 몫이 1
		 *                          => 11~19까지는 몫이 1, 20이 몫이 2
		 *                          => 21~29까지는 몫이 2, 30이 몫이 3
		...
		/*
		 * startPage, pageLimit에 영향을 받는 변수 (단, maxPage 도 영향을 주긴 함)
		 * 
		 * - 공식 구하기
		 * 단, pageLimit 가 10이라는 가정 하에 구해보자
		 * 
		...
		// 예시)
		// startPage 가 11이여서 endPage를 20 로 계산함
		// 근데 maxPage가 13페이지까지 밖에 안된다면?
		...
		//=> 일반게시판 뿐만 아니라 공지사항 게시판이나 사진게시판에서도 쓸수 있게끔 common 패키지에 만들것임
